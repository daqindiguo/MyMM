...
abstract public class BaseDataBoundAdapter<T extends ViewDataBinding> extends RecyclerView.Adapter<DataBoundViewHolder<T>> {
    ...
    @Override
    @CallSuper
    public DataBoundViewHolder<T> onCreateViewHolder(@Nullable ViewGroup parent, int viewType) {
    ...
    @Override
    public final void onBindViewHolder(@NotNull DataBoundViewHolder<T> holder, int position, List<Object> payloads) {
